...
add_action( 'wp_enqueue_scripts', 'synergie_scripts');
...
// Custom menu
function wpb_synergie_menu() {
  register_nav_menu('synergie-menu',__('Synergie Menu'));
}
add_action( 'init', 'wpb_synergie_menu');
...
add_image_size( 'hvrbox', 300, 375, true );
...
function clean_custom_menus() {
	$menu_name = 'synergie-menu'; // specify custom menu slug
